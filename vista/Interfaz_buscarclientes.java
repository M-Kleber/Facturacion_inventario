...
public class Interfaz_buscarclientes extends javax.swing.JInternalFrame {
   ...
   private Object[][] datostabla;    
    control_existencia ctr = new control_existencia();
    public Interfaz_buscarclientes() {
       ...
       public void mostrar_tabla(){
        control_cliente control = new control_cliente("Documento","Tipo de documento","Nombres","Apellidos","Direccion","telefono");       
        String[] columnas = {"Documento","Tipo de documento","Nombres","Apellidos","Direccion","Telefono"};
