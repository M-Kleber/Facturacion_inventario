 ...
 * @author CASKLE
 */
public class control_existencia {
    ...
    public void setId_articulo(String id_articulo) {
     ...
     public void registrar_factura(String Nnm_factura, String Nombre_empleado, String fecha_facturacion)
     {
        String[] datos = {Nnm_factura, Documento, Nombre_empleado,fecha_facturacion};
        sen.insertar(datos, "insert into factura(Nnm_factura,cod_cliente,Nombre_empleado,fecha_facturacion) values(?,?,?,?);");
    }
     ...
     public Object[][] datos_cliente(String id_cliente)
     {
        ...
        Object[][] resultado = sen.GetTabla(columnas, "cliente", "select * from cliente, tipo_de_documento where id_tipo_documento=cod_tipo_documento  and documento='"+id_cliente+"';");
        return resultado;
      }
      public Object[][] datos_detallefactura(String numero_factura)
     {
      ...
      public Object[][] consulta_factura(String id)
       {
        String[] columnas={"Nnm_factura","Nombres","Apellidos","Nombre_empleado","Fecha_facturacion","total_factura","IVA"};
        Object[][] resultado = sen.GetTabla(columnas, "cliente", "select * from cliente, factura, where documento=cod_cliente and documento='"+id+"';");
        return resultado;
       }
